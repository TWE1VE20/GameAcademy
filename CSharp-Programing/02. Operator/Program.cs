namespace _02._Operator
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //정수/정수의 경우 나머지 즉 소수점이 버려진다. 만약 소수점까지 포함하고 싶을경우 위와같이 실수/실수 정수/실수 등 실수를 포함해서 이를 실수로 저장을 해야 가능하다.
            iValue = 13 % 3;    // %(나머지)
            ...
            iValue = 10;
            bValue = false && (++iValue > 5); //-> 여기서 앞이 false이기에 뒤에  ++ iValue가 무시되어 ++가 처리되지 않는다
